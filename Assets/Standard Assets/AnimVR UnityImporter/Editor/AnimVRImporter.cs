...
namespace ANIMVR {
    ...
    [UnityEditor.AssetImporters.ScriptedImporter(1, "stage")]
    public class AnimVRImporter : UnityEditor.AssetImporters.ScriptedImporter {
        ...
        public struct Context {
            ...
            public UnityEditor.AssetImporters.AssetImportContext ctx;
            public TimelineAsset parentTimeline;
            public float fps;
            public int frameOffset;
        }

        public GameObject GenerateUnityObject(StageData stage, UnityEditor.AssetImporters.AssetImportContext ctx) {
